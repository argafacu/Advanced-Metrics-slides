...
Lecture 1: Introduction, Logistics and Recap 1 from intro course. Uncertainty in regression estimates, orthogonality of error, BLUE property.  [[HTML](https://github.com/argafacu/Advanced-Metrics-slides/blob/master/lectures/01-recap/recap1.html)]
